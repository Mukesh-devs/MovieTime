...
import dto.Movie;
import dto.ShowTime;
import features.movie.MovieView;
            ...
            for (Booking booking : userBookings) {
                ...
                if ( movie != null && showTime != null) {
                    Util.message("\nBooking Id" + booking.getBookingId() +
                            "\nMovie Name : " + MovieDb.getInstance().getMovieById(booking.getMovieId()) +
                            "\nShow Date & Time : " + showTime.getShowtimeDate() + "at" + showTime.getShowtimeTime() +
